 ...
 *
 * This file configures which features are available in the content moderation editor.
...
/**
 * Configure which features are enabled in the content moderation editor.
 *
...
export function setupFeatures(cesdk: CreativeEditorSDK): void {
  ...
  // ============================================================================
  // DISABLED FEATURES
  // Features explicitly disabled for content moderation workflow
  // ============================================================================
